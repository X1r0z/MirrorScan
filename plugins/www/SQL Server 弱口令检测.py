...
def audit(arg):
    ...
    try:
        O0o0O00Oo0o0 = ii11i()
        if O0o0O00Oo0o0.login(iIIIi1, iiII1i1, 'sbuser', 'sbpass') != False:
            return
    except:
        debug(sys.exc_info())
        return
    ...
    for iiI111I1iIiI in i1i:
        oooo000.push((oooo000, iIIIi1, iiII1i1, iiI111I1iIiI[0], iiI111I1iIiI[1]))

    oooo000.run()
    if iI1I111Ii111i:
        security_hole('%s:%d mssql password is %s/%s' % (iIIIi1, iiII1i1, iI1I111Ii111i, I11IiI1I11i1i))