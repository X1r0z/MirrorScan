                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div id="report" class="tab-pane fade active in">
                                <h4 class="blue"> 报告 </h4>

                                <div class="space-8"></div>

                                <div id="report" class="panel-group accordion-style1 accordion-style2">

                                    {% for url,item in report.items() %}

                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <a href="#{{ report.keys().index(url) }}" data-parent="#report" data-toggle="collapse" class="accordion-toggle collapsed">
                                        ...
                                        <div class="panel-collapse collapse" id="{{ report.keys().index(url) }}">
                                            <div class="panel-body">
                                                {% for level,value in item.items() %}
                                                {% if level == 'hole' %}
                                                <span class="label label-danger label-white middle">Hole</span>
                                                <ul style="list-style: none">
                                                    {% for name,body in value.items() %}
                                                    <li>
                                                        <span class="label-danger label-white middle">{{ name }}</span>
                                                ...
                                                {% end %}
                                                {% if level == 'warning' %}
                                                <span class="label label-warning label-white middle"> Warning </span>
                                                <ul style="list-style: none">
                                                    {% for name,body in value.items() %}
                                                    <li>
                                                        <span class="label-warning label-white middle">{{ name }}</span>
                                                        <ul class="list-unstyled">
                                                            {% for b in body %}
                                                            <li>
                                                                <i class="ace-icon fa fa-caret-right blue"></i>
                                                ...
                                                <ul style="list-style: none">
                                                    {% for name,body in value.items() %}
                                                    <li>
                                                        <span class="label-info label-white middle">{{ name }}</span>
                                                        <ul class="list-unstyled">
                                                            {% for b in body %}
                                                            <li>
                                                                <i class="ace-icon fa fa-caret-right blue"></i>
                                                ...
                                                {% end %}
                                                {% if level == 'note' %}
                                                <span class="label label-success label-white middle">Note</span>
                                                <ul style="list-style: none">
                                                    {% for name,body in value.items() %}
                                                    <li>
                                                        <span class="label-success label-white middle">{{ name }}</span>
                                                        <ul class="list-unstyled">
                                                            {% for b in body %}
                                                            <li>
                                                                <i class="ace-icon fa fa-caret-right blue"></i>
