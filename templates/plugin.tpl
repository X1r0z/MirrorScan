                                    ...
                                    <table id="simple-table" class="table  table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/plugin/Edit/{{ item.get('phash') }}"> {{ item.get('name') }}</a>
                                                </td>
                                                <td class="hidden-480">{{ item.get('author') }}</td>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        ...
                                                        <a href="/plugin/Edit/{{ item.get('phash') }}" class="btn btn-xs btn-info">
                                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                        </a>

                                                        <a href="/plugin/Del/{{ item.get('phash') }}" class="btn btn-xs btn-danger">
                                ...
                                <div class="col-xs-6">
                                    <div class="dataTables_paginate paging_simple_numbers"><ul class="pagination">
                                        ...
                                        <li class="paginate_button previous" aria-controls="dynamic-table" tabindex="0">
                                            <a href="/plugin/Page/{{ cur -1 }}">Prev</a>
                                        </li>
                                        {% end %}
                                        {% for n in range(1,per + 1) %}
                                        {% if cur == n %}
                                        <li class="paginate_button active" aria-controls="dynamic-table" tabindex="0">
                                            <a href="/plugin/Page/{{ n }}">{{ n }}</a>
                                        </li>
                                        {% else %}
                                        ...
                                        <li class="paginate_button next" aria-controls="dynamic-table" tabindex="0">
                                            <a href="/plugin/Page/{{ cur + 1}}">Next</a>
                                        </li>
                                        {% end %}
                                    </ul>
                                </div>
